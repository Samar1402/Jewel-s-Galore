...
  
  const productMenu = [
    { name: "Pendants", path: "/admin/products/pendants" }, 
    { name: "Bracelets", path: "/admin/products/bracelets" },
    { name: "Ear Ring", path: "/admin/products/earrings" },
    { name: "Rings", path: "/admin/products/rings" },
    { name: "Gift Hamper", path: "/admin/products/gift-hamper" },
  ];
  
  const ordersMenu = [
