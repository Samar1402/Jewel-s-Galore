...
    { name: "Orders", icon: FaShoppingCart, dropdown: true }, // The main dropdown trigger
    { name: "Reports", path: "/admin/reports", icon: FaFileAlt },
    { name: "Analytics", path: "/admin/analytics", icon: FaChartLine },
  ];

  const ordersMenu = [
    { name: "Order Requests", path: "/orders" }, // Use the root '/orders' path which redirects Admin to OrderRequests.jsx
