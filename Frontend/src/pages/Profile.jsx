...
const Profile = () => {
  ...
  // Handle upload — **this is where your Axios code goes**
  const handleUpload = async () => {
    ...
    try {
      ...
      console.log(res.data); // ✅ this is where you see the server response
        ...
        <div className="flex flex-col items-center border p-8 rounded shadow w-96">
          ...
          {image && (
            <button
              ...
              onClick={handleUpload} // <--- Axios code runs here
            >
              Upload
            </button>
          )}
